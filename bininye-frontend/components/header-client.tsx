...
import type { GlobalSettings } from "@/lib/strapi-global-settings"
                ...
                <Link href="/" className="flex items-center gap-3 transition-opacity hover:opacity-80">
                    {settings.logoUrl ? (
                        <Image
                            ...
                            width={48}
                            height={48}
                            className="h-12 w-12 rounded-xl object-contain bg-white shadow-md border border-border/50"
                        />
                    ) : (
                    ...
                    <div className="hidden flex-col sm:flex">
                        <span className="text-base font-bold leading-tight text-foreground">{settings.siteName}</span>
                        <span className="text-xs text-muted-foreground">
                            {settings.siteTagline || "[Slogan non récupéré]"}
                        </span>
                    </div>
                </Link>
